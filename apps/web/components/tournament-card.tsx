      ...
      <div className="p-5">
        ...
        <div className="mt-5 flex gap-2">
          ...
          <Link
            ...
            className="inline-flex h-11 flex-1 items-center justify-center rounded-lg border border-cyan-300/25 bg-white/8 px-4 text-sm font-semibold text-white transition hover:border-cyan-300/60 hover:bg-white/12"
          >
            View
          </Link>
        </div>
