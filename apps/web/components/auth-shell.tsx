      ...
      <div className="mx-auto flex min-h-[calc(100vh-4rem)] w-full max-w-6xl items-center justify-center">
        <section className="grid w-full items-center gap-8 lg:grid-cols-[1fr_440px]">
          <div className="hidden lg:block">
            <div className="mb-6 inline-flex rounded-md border border-cyan-300/20 bg-cyan-300/10 px-3 py-1 text-xs font-semibold uppercase tracking-[0.24em] text-cyan-100">
              FFX ESPORTS
            </div>
            ...
            <div className="mt-8 grid max-w-2xl grid-cols-3 gap-3">
              {["Free Fire", "BGMI", "CODM", "Valorant", "Wallet", "Live Rooms"].map((item) => (
                <div key={item} className="rounded-lg border border-white/10 bg-white/[0.06] px-4 py-3 text-sm font-semibold text-slate-200">
                  {item}
                </div>
              ))}
            </div>
          ...
          <div className="rgb-border rounded-xl">
            <div className="glass-panel rounded-xl p-6 shadow-neon sm:p-8">
              <div className="mb-7">
                <div className="mb-3 text-sm font-bold uppercase tracking-[0.24em] text-cyan-200">FFX ESPORTS</div>
